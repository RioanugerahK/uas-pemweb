    ...
    <div class="desktop">
      <div class="div">
        <div class="overlap-group">
          ...
          <a href="welcome.blade.php" class="text-wrapper">Home&nbsp;&nbsp; </a>
          <a href="about.blade.php" class="span">About&nbsp;&nbsp;</a>
          <a href="services.blade.php" class="text-wrapper">Services&nbsp;&nbsp;</a>
          ...
          <p class="HOME">
            ...
            <span class="text-wrapper-5">ABOUT US</span>
          </p>
        ...
        <img class="image" alt="Image" src="cleaning.jpg" />
      </div>
    </div>
  </body>
</html>
